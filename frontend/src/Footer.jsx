...
const Footer = () => {
  // Common styling for footer links
  const footerLinkStyle = "hover:text-[#0059B2] transition-colors duration-300 cursor-pointer";
    ...
    <footer className="bg-white text-gray-600 py-16 px-6 md:px-16 border-t border-blue-100">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1">
          <div className="flex items-center gap-2 mb-6">
            <div className="h-10 w-10 overflow-hidden rounded shadow-sm border border-gray-50">
              <img src="/jd-logo.jpeg" alt="Jay Dynamic Solutions Logo" className="object-contain w-full h-full" />
            </div>
            <h2 className="text-xl font-bold text-[#0059B2] tracking-tight">Jay Dynamic Solutions</h2>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm font-medium">
            <li><a href="/#home" className={footerLinkStyle}>Home</a></li>
            <li><a href="/#services" className={footerLinkStyle}>Services</a></li>
            <li><a href="/#internship" className={footerLinkStyle}>Internships</a></li>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-gray-500">
            <li className="hover:text-gray-800 transition-colors">Web & Mobile App</li>
            <li className="hover:text-gray-800 transition-colors">Machine Learning</li>
            <li className="hover:text-gray-800 transition-colors">Corporate Training</li>
      ...
      <div className="mt-16 pt-8 border-t border-blue-50 flex flex-col items-center">
        <p className="text-[10px] text-gray-400 uppercase tracking-[0.2em] mb-3">
          © {new Date().getFullYear()} Jay Dynamic Solutions. All rights reserved.
        </p>
